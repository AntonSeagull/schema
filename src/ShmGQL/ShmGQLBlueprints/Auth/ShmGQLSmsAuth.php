...
class ShmGQLSmsAuth extends ShmGQLAuthBase
{
            ...
            'resolve' => function ($root, $args) {
                ...
                if (isset($args['code'])) {
                    ...
                    if (!$findAuthUser) {
                        ...
                        ShmGQLUtils::validError("Неверный SMS код");
                    }
                    ...
                    if (!$user) {
                        ...
                        if ($this->onlyAuth) {
                            ShmGQLUtils::validError("Регистрация по SMS ограничена");
                        }

                        $authStructure = $this->authStructures[0] ?? null;

                        if (!$authStructure) {
                            ShmGQLUtils::validError("Регистрация по SMS недоступна");
                        }
                        ...
                        if (!$phoneField) {
                            ShmGQLUtils::validError("Регистрация по SMS не поддерживается");
                        }
